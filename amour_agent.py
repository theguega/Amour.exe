...
class MistralCaller:
    ...
    def _ensure_native_agents(self, agent_type: Literal["girl", "man"]) -> dict[str, str]:
        ...
        primary_instr = (
            ...
            "- Use humor, vulnerability, and emotional mirroring. "
            ...
            "Only use web_search when the user asks a clearly factual question. "
...
def _build_reply_system(agent_type: Literal["girl", "man"], mood_profile: str = "neutral") -> str:
    ...
    return (
        ...
        "Write one natural reply. KEEP IT SHORT: max 1-2 sentences, like a real spoken conversation. Never monologue. "
